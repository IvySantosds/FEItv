...
public class TelaVideo extends JFrame {
    ...
    public TelaVideo(Usuario user) {
        ...
        painelCadastro.setBorder(
                BorderFactory.createTitledBorder("Administração de Vídeos"));
        ...
        JButton btnExcluir =
                new JButton("Excluir Selecionado");
        ...
        JPanel painelAcoesUsuario =
                new JPanel(new BorderLayout(5, 5));

        painelAcoesUsuario.setBorder(
        ...
        JButton btnDescurtir =
                new JButton("Descurtir");
        ...
        add(new JScrollPane(tabelaVideos),
                BorderLayout.CENTER);
    ...
    private void adicionarAosFavoritos() {
        ...
        try {
            ...
            List<Playlist> playlists =
                    pDao.listarPorUsuario(usuario.getId());
    ...
    private void assistirVideo() {
        ...
        try {
            ...
            String titulo =
                    (String) modeloTabela.getValueAt(linha, 1);
